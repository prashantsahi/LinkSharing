...
class BootstrapService {
    ...
    void createResources(User user1, Topic topic1) {
        5.times {
            ...
            DocumentResource document = new DocumentResource(createdBy: user1, topic: topic1,title: "titleDoc$documentCount" ,description: "$topic1.name-doc$it-description", filePath: "/path/file${documentCount}")
            ++linkCount
            ++documentCount
