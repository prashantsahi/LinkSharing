<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title">Top Stories
            <span style="float:right " class="panel-title noUnderline"><g:link class="noUnderline" controller="login"
        ...
        <g:each in="${ratings}" var="rating">
            <div class="media">
                ...
                <div class="media-body media-marg">
                    <h4><a class="noUnderline" href="${createLink(controller: 'topic', action: 'topicShow', params: ['topic': rating?.resource?.topic?.id])}"
                    ...
                    <h4 class="media-heading"><g:render template="/templates/logos"/>
                        <a class="noUnderline" href="${createLink(controller: 'home', action: 'posts', params: [resource: rating?.resource?.id])}"
