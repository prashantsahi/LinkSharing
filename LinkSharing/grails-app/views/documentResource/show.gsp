...
<%@ page import="com.intelligrape.prashant.linksharing.DocumentResource" %>
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
		...
		<div id="show-documentResource" class="content scaffold-show" role="main">
			...
			<ol class="property-list documentResource">
				...
				<li class="fieldcontain">
					<span id="resourceratings-label" class="property-label"><g:message code="documentResource.resourceratings.label" default="Resourceratings" /></span>
