<%@ page import="com.intelligrape.prashant.linksharing.Topic; com.intelligrape.prashant.linksharing.User; first_grail_project.DocumentResource" %>
...
<div class="fieldcontain ${hasErrors(bean: documentResourceInstance, field: 'createdBy', 'error')} required">
	...
	<g:select id="createdBy" name="createdBy.id" from="${com.intelligrape.prashant.linksharing.User.list()}" optionKey="id" required="" value="${documentResourceInstance?.createdBy?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: documentResourceInstance, field: 'topic', 'error')} required">
	...
	<g:select id="topic" name="topic.id" from="${com.intelligrape.prashant.linksharing.Topic.list()}" optionKey="id" required="" value="${documentResourceInstance?.topic?.id}" class="many-to-one"/>
