    ...
    <div class="panel-body">
        ...
        <div class="media">
            ...
            <div class="media-body">
                ...
                <br>
                <h5 class="des-head">
                    <g:link name="subscription" controller="subscription" action="viewAllSubscriptions">Subscriptions</g:link>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <g:link name="topics" controller="subscription" action="viewAllSubscriptions" params='[topicFlag:"true"]'>Topics</g:link></h5>
